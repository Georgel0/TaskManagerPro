    ...
    <div className="task-info-group">
      ...
      <div className="task-detail-row task-item-details">
        ...
        {task.assigned_user_name && (
          <span className="task-assigned-user">
    ...
    <div className="task-meta-group">
      ...
      {hasEditRights && (
        <div className="action-buttons">
          <button className="btn-icon edit-btn" onClick={(e) => { e.stopPropagation(); onEdit(task); }}>
            <i className="fas fa-pencil-alt"></i>
          </button>
          <button className="btn-icon delete-btn" onClick={(e) => { e.stopPropagation(); onDelete(task); }}>
